...
export const skillGroups: SkillGroup[] = [
  {
    ...
    items: ["LangGraph", "LangChain", "RAG", "Tool-calling", "Agents"],
  },
  {
    title: "Models & APIs",
    items: ["Azure OpenAI", "GPT-4o/4.1", "Mistral", "text-embedding-3-large"],
  },
  {
    title: "ML",
    items: ["PyTorch", "scikit-learn", "NumPy", "Pandas", "Hugging Face"],
  },
  {
    title: "Vector & Retrieval",
    items: ["pgvector", "Azure AI Search", "RRF", "Hybrid Search"],
  },
  {
    title: "Infra & Data",
    items: ["PostgreSQL", "Redis", "Oracle 23ai", "Docker", "Azure", "Git"],
  },
  {
    title: "Frameworks",
    items: ["FastAPI", "Pydantic", "Next.js"],
  },
  {
    title: "Languages",
